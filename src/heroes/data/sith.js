export const sith = [
    ...
    },
    {
        ...
        'quote': '"You think you can turn him? Pathetic child, I cannot be betrayed. I cannot be beaten. I see his mind. I see his every intent! Yes, I see him turning the lightsaber to strike true. And now, foolish child, he ignites it, and kills his true enemy!" ―Snoke`s final words, to Rey and Kylo Ren―',
        'description': 'Snoke was a Force-sensitive humanoid genetic strandcast male who ruled the First Order as Supreme Leader during the New Republic Era. Possibly unaware of his true nature, Snoke was an artificial genetic construct created on the planet Exegol by the Dark Lord of the Sith and Galactic Emperor Darth Sidious and his Sith Eternal cult during the reign of the Galactic Empire. After Sidious` resurrection, Snoke`s body held no use in the Sith Lord`s goal for restoration, so was instead utilized by Sidious for his natural Force-sensitivity as a proxy he could manipulate for his Contingency. Though Snoke possessed an independent mind, he was obliviously influenced by his creator from afar.'
    }
]